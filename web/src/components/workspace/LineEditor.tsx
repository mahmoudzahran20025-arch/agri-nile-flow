  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div
        ...
        style={{ gridTemplateColumns: '32px 2fr 80px 90px 110px 80px 80px 28px', minWidth: '740px' }}
      >
      ...
      <div className="flex-1 overflow-y-auto py-1 space-y-0.5 px-2" style={{ minWidth: '740px' }} onPaste={handleGridPaste}>
        {lines.map((line, idx) => (
          <LineRow
            key={line._key}
            line={line}
