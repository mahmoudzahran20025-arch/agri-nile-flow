-- ============================================================================
-- PHASE 3B: LINK ITEMS TO NEW PRODUCT POSTING GROUPS
-- Links: SEED, CHEM, HARVEST, EQUIP_CAP, EQUIP_CONS
-- Date: April 30, 2026
-- ============================================================================

-- First, check what items we have and their current posting_group_code
...
-- Items that are basic seeds (not SEEDS which is تقاوي)
-- ============================================================================
UPDATE items 
...
-- For finished crops that are harvested
-- ============================================================================
UPDATE items 
...
-- EQUIP_CAP: Capital equipment (machinery, tractors, large equipment)
UPDATE items 
...
-- EQUIP_CONS: Consumables/spare parts (small items, replacement parts)
UPDATE items 
...
-- Show items without PPG (if any remain)
...
-- Sample of linked items by category
SELECT 'Sample SEED items' as category, item_code, item_name, posting_group_code 
FROM items 
WHERE posting_group_code = 'SEED' AND company_id = 1 
LIMIT 5;

SELECT 'Sample CHEM items' as category, item_code, item_name, posting_group_code 
FROM items 
WHERE posting_group_code = 'CHEM' AND company_id = 1 
LIMIT 5;

SELECT 'Sample HARVEST items' as category, item_code, item_name, posting_group_code 
FROM items 
WHERE posting_group_code = 'HARVEST' AND company_id = 1 
LIMIT 5;

SELECT 'Sample EQUIP_CAP items' as category, item_code, item_name, posting_group_code 
FROM items 
WHERE posting_group_code = 'EQUIP_CAP' AND company_id = 1 
LIMIT 5;

SELECT 'Sample EQUIP_CONS items' as category, item_code, item_name, posting_group_code 
FROM items 
WHERE posting_group_code = 'EQUIP_CONS' AND company_id = 1 
LIMIT 5;
