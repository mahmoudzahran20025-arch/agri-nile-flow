...
export const SUPPLIERS_CONFIG = {
  ...
  transSheet: {
    ...
    columns: {
      ...
      entry_type:       1,          // Column 1: النوع (د/م)
      supplier_code:    2,          // Column 2: كود المورد
      narration:        4,          // Column 4: البيان (Description)
      document_type:    5,          // Column 5: نوع المستند
      document_number:  6,          // Column 6: رقم المستند
      expense_category: 7,          // Column 7: المصروف
      equipment:        8,          // Column 8: المعدة
      service:          9,          // Column 9: الخدمة
      account_code:     10,         // Column 10: كود الحساب
      unit:             16,         // Column 16: الوحدة
      ...
      year:             27,         // Column 27: سنة الانشاء
      month:            28,         // Column 28: شهر الانشاء
      notes:            30,         // Column 30: ملاحظات
    },
  },
}
