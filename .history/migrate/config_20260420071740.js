...
export const SUPPLIERS_CONFIG = {
  ...
  transSheet: {
    name:     'البيان',
    startRow: 2,                    // Skip row 1 (جزئي summary)، البيانات من row 2
    columns: {
      supplier_code:    '__EMPTY_1',    // كود المورد
      transaction_date: '__EMPTY',      // التاريخ (Excel date serial)
      entry_type:       'د',            // من column "د" (نوع: م/د)
      debit_amount:     '__EMPTY_20',   // مدين
      credit_amount:    '__EMPTY_19',   // دائن
      quantity:         '__EMPTY_16',   // الكمية
      unit_price:       '__EMPTY_17',   // السعر
      amount:           '__EMPTY_18',   // القيمة
      notes:            '__EMPTY_29',   // ملاحظات
    },
  },
}
