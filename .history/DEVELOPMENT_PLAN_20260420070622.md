...
- [x] تغيير كلمة المرور — backend endpoint + Header dropdown
- [x] صفحة التقارير المالية الشاملة
- [x] صفحة الشركاء + CRUD كامل
- [x] CLI استيراد بيانات Excel (migrate/)

### المرحلة الثالثة — استيراد البيانات الفعلي (التالي)
- [ ] **ضبط config.js** — تحديد أسماء الـ sheets والأعمدة
...
### المرحلة الثالثة — استيراد البيانات
- [ ] CLI لاستيراد ملفات Excel الثلاثة إلى D1
  - ملف 1: الموردين وحركات الحسابات
  - ملف 2: الخزينة والحركات النقدية
  - ملف 3: المخازن والمخزون

### المرحلة الرابعة — تقارير وتوسع
- [ ] صفحة التقارير المالية (تصدير Excel / PDF)
- [ ] موديول العمليات الزراعية (مهام، رش، ري)
